...
export default function (
  ...
  const url = encodeURIComponent(
    (new URL(window.location.href).pathname + window.location.search).replace(
      /^\/|\/$/g,
      ""
    )
  );
  ...
  $element.html(`<div class="adminBar-logo">
        ...
        ${
         ...
         <div class="adminBar-links">
            ${
              contextualMatch
                ? `<a href='${secureBaseUrl}${contextualMatch.url}' target="_blank">
